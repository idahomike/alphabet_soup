...
### Commanline execution for building, test and execution

```
mvn initialize                                                // to initialize
mvn test                                                      // to run unit tests
mvn package                                                   // to buld executable jar file
java -jar target/alphabet-soup-1.0-SNAPSHOT.jar  <filename>   // execute to find solution key
```